            ...
            do{
                ...
                if (pin==1234)//cek pin
                    do{
                        ...
                        switch (choice){
                            case 1:
                                JOptionPane.showMessageDialog(null,"saldo Anda saat ini sebesar : " + tab); //info saldo
                            ...
                            case 2:
                                ...
                                if (z==0)
                                    ...
                                    JOptionPane.showMessageDialog(null, "Terimakasih telah menggunakan ATM BNI, silahkan ambil kartu Anda.");
                                System.exit(0);
